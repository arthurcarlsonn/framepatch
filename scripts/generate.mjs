  ...
  await writeFile(
    ...
    render(
      `// GENERATED by \`pnpm enrich\` — do not edit by hand.\n` +
        `// ${records.length} records, ${verified} with a verified figure. Every figure here\n` +
        `// cites the source that states it; see ./fps.ts for how the app reads them.\n`,
...
export async function generate() {
  ...
  await writeFile(
    INDEX_FILE,
    render(
      head("List index — shipped to the browser. Frame rates live in ./fps.generated.ts."),
